      ...
      <div className={`main__content ${isVisible ? 'main__content_visible' : ''}`}>
        <>
          ...
          <p className="main__subtitle">
            Добро пожаловать на наш сайт случайного поиска блюд! Функция случайного поиска поможет
            вам открыть для себя новые и интересные блюда, которые вы можете приготовить дома или
            заказать в ресторане. Просто нажмите кнопку "Начать" и наслаждайтесь удивительными
            результатами!
          </p>
